...
prefeituras_disponiveis = [
    ...
    'prefeituraosasco',
    'prefeiturasaobernardo',
    'prefeituraguarulhos',
    'prefeiturabarueri',
    'prefeiturasaocaetano',
    'prefeituracampinas',
    'prefeiturasantoandre',
    'prefeiturapraiagrande',
    ...
    'prefeituraetparanapanema',
    'prefeiturasertaozinho',
    'prefeiturasumare',
    'prefeiturasuzano',
    'prefeituravarzeapaulista',
    'prefeituravotuporanga',
    'prefeiturajundiai',
    'prefeituralimeira',
    ...
    'prefeituracajamar',
    'prefeituracubatao',
    'prefeituraferrazvasconcelos',
    'prefeituraitapecerica',
    'prefeiturajacarei',
    'prefeiturataubate',
    'prefeiturasaocarlos',
    'prefeituraparnaiba',
    'prefeiturabraganca',
    'prefeituramaua',
    'prefeituraembudasartes',
    'prefeituracamposjordao',
    'prefeiturahortolandia',
    'prefeituracaraguatatuba',
    'prefeiturapindamonhangaba'
]
